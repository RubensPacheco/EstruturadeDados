...
#assunto pilhas com o desempilhamento retornando o item deletado se existir
...
# a pilha esta cheia retornar falso
        if self.tamatual==len(self.dados):
            return False
# a pilha não esta cheia, pode acrescentar elemento
...
#sempre retira o último que foi empilhado
    def desempilhar(self):
        ...
        return True, y
#para nao repetir tato o if e os prints
def imprimirdesempilhar(situacao,y):
    if situacao:
...
imprimirdesempilhar(situacao,y)
l.mostrar()
